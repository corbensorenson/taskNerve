import { DEFAULT_LOW_QUEUE_CONTROLLER_PROMPT, PROJECT_GOALS_FILE, PROJECT_MANIFEST_FILE, } from "../constants.js";
...
export function buildControllerBootstrapPrompt(options) {
...
${renderBulletList(options.currentStateSignals, "Review the repo structure and summarize the implementation shape.")}

Timeline and context signals:
${renderBulletList(options.timelineSignals, "Review the TaskNerve timeline/checkpoints before planning new work.")}
...
- Use this heartbeat core for workers unless the project overrides it later: ${options.heartbeatCore || "use the project default heartbeat core"}.
- When the queue runs low, use this controller refill prompt as the baseline behavior: ${options.lowQueuePrompt || DEFAULT_LOW_QUEUE_CONTROLLER_PROMPT}
...
//# sourceMappingURL=controllerBootstrap.js.map