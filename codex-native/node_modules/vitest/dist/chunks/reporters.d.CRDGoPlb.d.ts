...
export { Logger as L, TestProject as T, Vitest as V, DefaultReporter as _, DotReporter as a0, GithubActionsReporter as a2, HangingProcessReporter as a4, JUnitReporter as a6, JsonReporter as a9, TestModule as aA, TestSuite as aL, VerboseBenchmarkReporter as aQ, VerboseReporter as aR, VitestPackageInstaller as aT, experimental_getRunnerTask as aW, CoverageMap as aX, ReportersMap as ao, TapFlatReporter as au, TapReporter as av, TestCase as ax, TestCollection as ay, TestSpecification as i, BaseReporter as m, BenchmarkReporter as o, BenchmarkReportsMap as p };
export type { DepsOptimizationOptions as $, ApiConfig as A, BaseCoverageOptions as B, CoverageV8Options as C, BrowserScript as D, BrowserServerFactory as E, BrowserServerOptions as F, BrowserServerState as G, BrowserServerStateSession as H, InlineConfig as I, BuiltinEnvironment as J, BuiltinReporterOptions as K, BuiltinReporters as M, CSSModuleScopeStrategy as N, CoverageIstanbulOptions as O, PoolWorker as P, CoverageOptions as Q, ResolvedCoverageOptions as R, CoverageProvider as S, UserWorkspaceConfig as U, WatcherTriggerPattern as W, CoverageProviderModule as X, CoverageReporter as Y, CustomProviderOptions as Z, TestProjectConfiguration as a, EnvironmentOptions as a1, HTMLOptions as a3, JUnitOptions as a5, JsonAssertionResult as a7, JsonOptions as a8, TestModuleState as aB, TestResult as aC, TestResultFailed as aD, TestResultPassed as aE, TestResultSkipped as aF, TestRunEndReason as aG, TestRunResult as aH, TestSequencerConstructor as aI, TestSpecificationOptions as aJ, TestState as aK, TestSuiteState as aM, ToMatchScreenshotComparators as aN, ToMatchScreenshotOptions as aO, TypecheckConfig as aP, VitestEnvironment as aS, WorkerResponse as aU, _BrowserNames as aV, JsonTestResult as aa, JsonTestResults as ab, ModuleDiagnostic as ac, OnServerRestartHandler as ad, OnTestsRerunHandler as ae, ParentProjectBrowser as af, Pool as ag, PoolRunnerInitializer as ah, PoolTask as ai, ProjectBrowser as aj, ProjectConfig as ak, ReportContext as al, ReportedHookContext as am, Reporter as an, ResolveSnapshotPathHandler as ap, ResolveSnapshotPathHandlerContext as aq, ResolvedBrowserOptions as ar, ResolvedProjectConfig as as, SerializedTestProject as at, TaskOptions as aw, TestDiagnostic as az, UserProjectConfigFn as b, UserProjectConfigExport as c, TestProjectInlineConfiguration as d, UserConfig as e, ResolvedConfig as f, VitestRunMode as g, VitestOptions as h, PoolOptions as j, WorkerRequest as k, TestSequencer as l, BenchmarkBuiltinReporters as n, BenchmarkUserOptions as q, BrowserBuiltinProvider as r, BrowserCommand as s, BrowserCommandContext as t, BrowserConfigOptions as u, BrowserInstanceOption as v, BrowserModuleMocker as w, BrowserOrchestrator as x, BrowserProvider as y, BrowserProviderOption as z };
